...
const Results = () => {
  ...
  const fetchResults = useCallback(async () => {
    try {
      ...
      console.log('Events received from backend:', data.events);
      console.log('Events array length:', data.events ? data.events.length : 'undefined');
      console.log('Sample event structure:', data.events && data.events[0] ? data.events[0] : 'no events');
